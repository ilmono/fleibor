                ...
                <div>
                    <div id="test-modal" class="mfp-hide white-popup-block">
                        ...
                        <form method="POST" style="display: inline;">
                            ...
                            <input class="btn btn-small btn-success" type="submit" name="btn-guardar" value="Realizar Pedido">
                        </form>
                        ...
                        <div class="widget-content" style="padding-top: 15px;">
                            <div class="control-group">
                                ...
                                <div class="pedidos-ver-acciones">
                                    ...
                                    <form method="POST" style="display: inline;">
                                        <input type="hidden" name="pedido_id" value="<?php echo $pedido['id']?>"/>
                                        <input class="btn btn-small btn-danger btn-pedidos-accion" type="submit" name="btn-recordar" value="Reclamar Pedido">
                                    </form><br />
                                    <form method="POST" style="display: inline;">
                                        <input type="hidden" name="pedido_id" value="<?php echo $pedido['id']?>"/>
