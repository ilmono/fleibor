...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2016 a las 04:16:05
...
INSERT INTO `productos` (`id`, `familia`, `nombre`, `descripcion`, `subtitulo`) VALUES
(1, 1, 'Listado de Colores en Pasta', '', ''),
(2, 2, 'Colorante para Aerografos', '', '');
...
--
-- Estructura de tabla para la tabla `producto_envases`
--

CREATE TABLE IF NOT EXISTS `producto_envases` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_producto` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `producto_envases`
--

INSERT INTO `producto_envases` (`id`, `id_producto`, `id_envase`) VALUES
(1, 1, 3),
(2, 0, 4),
(3, 2, 4);
...
INSERT INTO `producto_medidas` (`id`, `id_producto`, `id_medida`) VALUES
(1, 1, 8),
(2, 1, 9),
(3, 0, 12),
(4, 2, 12);
...
INSERT INTO `producto_unidades` (`id`, `id_producto`, `id_unidades`) VALUES
(1, 1, 4),
(2, 1, 6),
(3, 1, 7),
(4, 0, 4),
