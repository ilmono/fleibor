	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			<div class="events-tittle">
	        	<h3 class="letter-title">Bebidas Sin Alcohol</h3>
	      	</div>
	      	<div class="content company row">
	      		<div class="">
	      			<p>Mediante la<span class="strong">combinación de colores y esencias</span>  fleibor se pueden lograr bebidas de excelente calidad 
					obteniendo los distintos sabores frutales que usted pueda imaginar. </p>
					<p>En la elaboración de <span class="strong">jugos, gaseosas, licuados,</span> usted tiene la posibilidad de innovar 
					utilizando nuestros aditivos que le darán originalidad a su producto. </p>
					<p>Los <span class="strong">productos</span> que ofrecemos relacionado con las <span class="strong">bebidas sin alcohol</span> son los siguientes: </p>
	      		</div>
	      	</div>
			<br>
			...
			<div class="panel-heading">Listado de Escencias</div>
				...
				<td><strong>ESENCIA</strong> TUTTI FRUTI</td>
				</tr>
