	...
	<body>
	    ...
	    <div class="container company col-md-offset-2 col-md-8">
			...
			<div class="panel-heading">Listado de Colorantes L&iacute;quidos</div>
				...
				<br/>
					<p>
					<li><span class="strong">BAÑO MARRON </span>.</li>
					</p>
					<br/>
					<p>
					<li><span class="strong">BAÑO BLANCO</span> </li>
					</p>
					<br/>
					<p>
					...
					<br/>
					<p>
					<li><span class="strong">GLICERINA</span></li>
					</p>
					<br/>
					<p>
					<li><span class="strong">EXTRACTO DE MALTA</span></li>
					</p>
					<br/>
					<p>
					<li><span class="strong">POLVO DE HORNEAR</span></li>
					</p>
					<br/>
					<p>
					<li><span class="strong">ACIDO ACETICO </span></li>
					</p>
					<br/>				
	      		</div>
	      	</div>
